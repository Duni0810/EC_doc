...
# Link all obj fils
# -----------------------------------------------------------------------------
ITE_EC.ABS:$(BuildPath_OBJ)\$(CoreModule00).OBJ\
           $(BuildPath_OBJ)\$(CoreModule01).OBJ\
...
# -----------------------------------------------------------------------------
$(BuildPath_OBJ)\$(CoreModule00).OBJ:SOURCE\$(CoreModule00).C SOURCE\*.H
         $(CC) SOURCE\$(CoreModule00).C $(CDirectives)
         move  SOURCE\$(CoreModule00).OBJ $(BuildPath_OBJ)
         move  SOURCE\$(CoreModule00).LST $(BuildPath_LST)

...
s.linkInternalFilters="javascript:,lenovo.com.cn,www.lenovo.com,lenovo.cn,lenovoad.com"
...
function s_doPlugins(s) {
	if(!s.campaign) {
		s.campaign=s.getQueryParam('ngAdID');
	...
	s.prop6=s.getTimeParting('h','8'); // Set hour
	s.prop7=s.getTimeParting('d','8'); // Set day
	s.eVar8=s.prop6;
	s.eVar9=s.prop7;
}
...
s.visitorNamespace="lenovochina"
s.dc="122"

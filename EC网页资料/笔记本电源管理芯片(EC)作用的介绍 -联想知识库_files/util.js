...
// $(function(){
// $("#closed_lenovoadd").on("click", function () {
//             $(".lenovo_add").animate({left:'-100%'}, 500, function () {
//                 $(".small_lenovo_add").animate({left: '0'}, 500);
//             });
//         });
//         $("#show_lenovoadd").on("click", function () {
//             $(".small_lenovo_add").animate({left:'-100%'}, 500, function () {
//                 $(".lenovo_add").animate({left:'0'}, 500);
//             });
//         });
// });
...
function goCreateKnowledge(){
    if($('#userNameText').html()=='Hi：Iknow'){
        ...
        alert('感谢您的贡献与支持，“我要创建”正在升级中~\n注：已贡献的知识不会有影响（财富值、经验值、知识审核等）');        
    }
...
$('.blue a').attr('href','http://ask.lenovo.com.cn/html/index.html')





// 扫码登录 wangxue 2017-10-26
var url = window.location.href;
var curHref =encodeURI(url.replace("&","@"));
var curTitle=encodeURI(document.title);
var curUrl =curHref+'$'+curTitle;
...
LID.Module = {
    ...
    iLoginQQ: function (sQuery) {
        //QQ 三方登入
        //测试环境
        window.location.href = 'http://uss.test.lenovomm.cn/wauthen2/gateway?lenovoid.thirdname=qqsns&' + sQuery;
        //产线环境
    ...
    iLoginSina: function (sQuery) {
        //Sina 三方登入
        //测试环境
        window.location.href = 'http://uss.test.lenovomm.cn/wauthen2/gateway?lenovoid.thirdname=sina&' + sQuery;
        //产线环境
    ...
    iLpsust: function (sLpsust) {
        ...
        var backUrl = 'http://' + window.location.host;
        var checkWustUrl = backUrl + '/Login/callback?lenovoid.wust=' + sLpsust + '&lenovoid.action=uilogin&lenovoid.realm=support1.lenovo.com.cn&lenovoid.ctx=&lenovoid.lang=null';
...
$(function () {
    ...
    function registerAjax() {
        ...
        if(nowUrl.indexOf("cn")!=-1){
             popWin.showWin("800", "600", "01", "http://passport.lenovo.com.cn/wauthen2/wauth/jsp/ilogin.jsp?lenovoid.action=uilogin&lenovoid.realm=support1.lenovo.com.cn&lenovoid.iframestate=wechat&lenovoid.cb=" + nowUrl + "/Login/callback&lenovoid.source=" + nowUrl);
        }else{
             popWin.showWin("800", "600", "01", "http://passport.lenovo.com/wauthen2/wauth/jsp/ilogin.jsp?lenovoid.action=uilogin&lenovoid.realm=support1.lenovo.com.cn&lenovoid.iframestate=wechat&lenovoid.cb=" + nowUrl + "/Login/callback&lenovoid.source=" + nowUrl);
        }
        //popWin.showWin("800", "600", "01", "http://passport.lenovo.com.cn/wauthen2/wauth/jsp/ilogin.jsp?lenovoid.action=uilogin&lenovoid.realm=support1.lenovo.com.cn&lenovoid.iframestate=wechat&lenovoid.cb=" + nowUrl + "/Login/callback&lenovoid.source=" + nowUrl);
    }
    //setCookie
...
iconLink.href="http://www.lenovo.com.cn/favicon.ico";
...
document.write("</div>")
var newTop ='<div class="site new_site fr fix header-login"><span class="login-link user_icon png" id="loginuserinfo">' +
            '<div class="detailBox" id="detailBox" style="width:240px;max-height: 400px;border: 1px solid #ccc;display: none;overflow: auto;position:absolute;top:26px;background-color:#eee;">'+
               '<ul id="UBox">'+
               '</ul>'+
           ' </div>'+
    '</div></div><div class="drop-win"><div class="login-drop"><div class="close-popwin">x</div>登录联想账号</div><div id="new_drop_main"></div></div></div>'
$("body").prepend(newTop);
var timerLogo;
$(function() {
